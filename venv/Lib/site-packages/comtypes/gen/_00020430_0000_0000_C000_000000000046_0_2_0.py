...
IFontDisp = Font
__all__ = [ 'Picture', 'VgaColor', 'OLE_YPOS_HIMETRIC', 'FONTBOLD',
           'FONTSIZE', 'OLE_XSIZE_PIXELS', 'IPicture', 'Font',
           'OLE_HANDLE', 'OLE_ENABLEDEFAULTBOOL', 'OLE_YSIZE_PIXELS',
           'Monochrome', 'OLE_YSIZE_CONTAINER', 'Gray', 'FontEvents',
           'OLE_CANCELBOOL', 'OLE_OPTEXCLUSIVE', 'OLE_XSIZE_HIMETRIC',
           'OLE_YPOS_PIXELS', 'FONTNAME', 'Unchecked',
           'IFontEventsDisp', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_PIXELS', 'OLE_TRISTATE', 'LoadPictureConstants',
           'FONTITALIC', 'Default', 'Color', 'IFont', 'StdPicture',
           'FONTSTRIKETHROUGH', 'StdFont', 'OLE_YSIZE_HIMETRIC',
           'IPictureDisp', 'OLE_XPOS_HIMETRIC', 'FONTUNDERSCORE',
           'OLE_YPOS_CONTAINER', 'OLE_COLOR', 'OLE_XPOS_CONTAINER',
           'Checked', 'IFontDisp']
